...
class WorldCupManager {
    ...
    class playerNode {
        ...
        teamNode *m_team;
    public:
        explicit playerNode() : m_key(-1), m_data(NULL), m_parent(NULL), m_rg(0), m_rs(permutation_t::neutral()),
                                m_team(
                                        NULL) {}
    ...
    class teamNode {
        ...
        bool m_isDeleted;
    public:
        explicit teamNode() : m_key(-1), m_data(NULL), m_rep(NULL), m_rank(0), m_team_spirit(permutation_t::neutral()),
                              m_isDeleted(
                                      false) {}
